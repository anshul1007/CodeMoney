...
@Component({
  ...
  template: `
    ...
    >
      <!-- Header -->
      <div class="bg-white shadow-sm border-b-4 border-yellow-400 p-4">
      ...
      <div class="max-w-4xl mx-auto p-6">
        ...
        <div
          *ngIf="currentLevel.gameData.scene"
          class="bg-white rounded-2xl shadow-lg p-6 mb-6 text-center"
        >
          <div class="text-6xl mb-4">🏪</div>
          <p class="text-lg text-gray-700">{{ currentLevel.gameData.scene }}</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          >
            <div class="flex items-center mb-2">
              ...
              <span class="font-medium text-blue-800">Hints:</span>
            </div>
          ...
          <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
            ...
            <div class="space-y-4">
              ...
              >
                ...
                <div class="flex items-center space-x-2">
                  <span class="text-lg">{{ field.currency }}</span>
                  <input
                    type="number"
                  ...
                  <div *ngIf="gameSubmitted" class="ml-4 text-sm">
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
              ...
              <div
                *ngIf="gameSubmitted"
                class="text-right text-sm text-gray-600 mt-1"
              >
        ...
        <div *ngIf="currentLevel.type === 'funding'" class="game-content">
          <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
              ...
              >
                ...
                >
                  <div class="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      <h4 class="font-bold text-gray-800">{{ source.name }}</h4>
                      <p class="text-sm text-gray-600">
                        {{ source.description }}
                      </p>
                    </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
              <h4 class="font-bold text-gray-800 mb-2">Funding Summary:</h4>
        ...
        <div class="text-center space-x-4">
          <button
            *ngIf="!gameSubmitted"
            (click)="submitAnswer()"
            class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-xl transition-colors duration-200 text-lg"
          >
            Submit Answer
          </button>
          ...
          <button
            *ngIf="!showHints && currentLevel.gameData.hints?.length"
            ...
            class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-xl transition-colors duration-200 text-lg"
          >
            💡 Show Hints
          </button>
          ...
          <button
            *ngIf="gameSubmitted"
            (click)="nextLevel()"
            class="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-xl transition-colors duration-200 text-lg"
          >
        ...
        <div
          *ngIf="gameSubmitted && lastScore > 0"
          class="mt-6 bg-green-50 border border-green-200 rounded-2xl p-6 text-center"
        >
          <div class="text-4xl mb-2">🎉</div>
          <h3 class="text-xl font-bold text-green-800 mb-2">Great Job!</h3>
          <p class="text-green-700 mb-3">You earned {{ lastScore }} stars!</p>
