...
@Component({
  ...
  templateUrl: './balance-equation-game.component.html',
  styleUrl: './balance-equation-game.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BalanceEquationGameComponent
    ...
    GameComponentWithReset
{
  ...
  readonly canSubmit = computed(() => {
    // Only enable submit if all items are placed AND the balance sheet is balanced
    return this.allItemsPlaced() && this.isBalanced() && !this.gameIsSubmitted();
  });
